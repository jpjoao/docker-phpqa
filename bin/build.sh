...
BUILD_PHP_VERSION="_${_VERSION}_PHP_VERSION"
BUILD_GPG_KEYS="_${_VERSION}_GPG_KEYS"
BUILD_PHP_SHA256="_${_VERSION}_PHP_SHA256"
BUILD_PHP_MD5="_${_VERSION}_PHP_MD5"

cd `git rev-parse --show-toplevel`
docker build \
    --build-arg BUILD_PHP_VERSION="${!BUILD_PHP_VERSION}" \
    --build-arg BUILD_GPG_KEYS="${!BUILD_GPG_KEYS}" \
    --build-arg BUILD_PHP_SHA256="${!BUILD_PHP_SHA256}" \
    --build-arg BUILD_PHP_MD5="${!BUILD_PHP_MD5}" \
